...
<div class="container-info">
    <div class="add_product">
        <form action="AggiungiListaServlet" enctype="multipart/form-data" method="POST">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="Privata" id="Pubblica" value="Pubblica" checked>
                <label class="form-check-label" for="Pubblica">Pubblica</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="Privata" id="Privata" value="Privata">
