...
<head>
  ...
  <script>
    ...
    // function addFilmToList(idFilm) {
    //   var idLista = document.querySelector('select[name="idLista"]').value;
    //
    //   if (!idLista) {
    //     alert("Errore: Seleziona una lista prima di aggiungere il film.");
    //     return;
    //   }
    //
    ...
    //       } else {
    //         alert("Errore durante l'aggiunta del film alla lista.");
    //       }
    //     }
    //   };
    //
    //   xhr.open("POST", "ListaServlet?action=aggiungiFilm&idFilm=" + idFilm + "&idLista=" + idLista, true);
    //   xhr.send();
    // }
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4" id="container-film">
    ...
    <div class="col" data-genre="<%=f.getGenere()%>" id="genere-paragraph">
      ...
      <div class="card h-100">
        <a href="#" class="btn btn-primary position-absolute top-0 end-0" id="link-addWatchlist">+</a>
